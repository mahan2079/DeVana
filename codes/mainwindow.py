...
from gui.sidebar_mixin import SidebarMixin
from gui.theme_mixin import ThemeMixin
from gui.stochastic_design_mixin import StochasticDesignMixin
...
class MainWindow(QMainWindow, MenuMixin, ContinuousBeamMixin, MicrochipPageMixin, SidebarMixin, ThemeMixin, StochasticDesignMixin):
    def __init__(self):
        super().__init__()
